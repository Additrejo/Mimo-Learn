...
Este bloque cubre el uso de operadores de comparacion con cadenas de texto. Los operadores de comparacion devuelven un valor booleano: `True` o `False`.
...
| ejercicio_07_practica_act_ace.py | Practica: my_answer == solution |
